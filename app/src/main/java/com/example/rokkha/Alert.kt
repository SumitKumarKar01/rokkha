...
class Alert :AppCompatActivity() {
    ...
    private val channelId = "RokkhaNotifications"
    private val channelName = "Rokkha Notification Channel"
    ...
    private fun sendLocationToContacts(location: Location) {
        ...
        val builder = NotificationCompat.Builder(this, channelId)
            ...
            .setContentText("Sending alert to contacts")
            .setSmallIcon(R.drawable.notification_icon)
            .setLargeIcon(BitmapFactory.decodeResource(resources, R.mipmap.ic_launcher_round))
            .setPriority(NotificationCompat.PRIORITY_HIGH)

        // Create a PendingIntent for the notification click
        val resultIntent = Intent(this, Alert::class.java)
